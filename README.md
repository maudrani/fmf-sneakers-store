- The idea of the app will be to create a fraework that include dynamic components that will use GLOBAL values for styling, such as colors, margin/padding, font sizes, etc.
